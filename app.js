    ...
    const Spaceship = {
        ...
        draw() {
            ...
            if (this.isThrusting) {
                ...
                ctx.fillStyle = `rgba(255, 165, 0, ${Math.random() * 0.8 + 0.2})`;
                ctx.beginPath();
                ctx.moveTo(this.x - this.width / 2 - 5, this.y);
                ctx.lineTo(this.x - this.width / 2 - 5 - flameLength, this.y - 5);
                ctx.lineTo(this.x - this.width / 2 - 5 - flameLength, this.y + 5);
                ctx.closePath();
                ctx.fill();
            }
    ...
    // Spaceship's bounding box based on its center point
